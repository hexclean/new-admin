...
function Products() {
  ...
  const getHeroes = () => {
    ...
    heroes.map((hero) =>
      heroesList.push(
        <div className="col-md-6 products-down padding-right" key={hero.id}>
          <div className="partner-inkbxtp margbtm-15">
            <div className="partner-inkbx">
              ...
              <div className="partner-inkbxrht">
                ...
                <p>
                  Lorem ipsum dolor sit amet, conse-ctetuer adipiscing. SI ipsum
                  dolor sit amet Lorem DOlor Si marto.
                </p>
